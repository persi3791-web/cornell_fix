            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            "Incluye: Notas, Resumen, Flashcards, Quizzes, Transcripción",
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            "Añade las notas del backup sin borrar las actuales",
                            style = MaterialTheme.typography.bodySmall,
                            color = CornellTextSecondary
                        )
                        OutlinedButton(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Column {
                                Text(
                                    if (useGpt4) "GPT-4o activo" else "Gemini activo",
                                    style = MaterialTheme.typography.bodyMedium,
                                    color = CornellText
                                )
                                Text(
                                    if (useGpt4) "GitHub Models (gratuito)" else "Google AI (gratuito)",
                                    style = MaterialTheme.typography.bodySmall,
                                    color = CornellTextSecondary
                                )
                            }
